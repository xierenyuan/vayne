...
function watch () {
  ...
  if (argv.config) {
    files.push(paths.resolveApp(argv.config))
  }
...
args.push('--config', resolve('lib/config/webpack.dev.conf'))
server = fork(require.resolve('webpack-dev-server/bin/webpack-dev-server.js'), args)
