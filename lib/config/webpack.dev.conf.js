    ...
    if (err) {
      ...
      devWebpackConfig.plugins.push(new FriendlyErrorsPlugin({
        compilationSuccessInfo: {
          messages: [log.log('success', `Your application is running here: http://${devWebpackConfig.devServer.host}:${port}`)]
        },
        onErrors: config.dev.notifyOnErrors
          ? utils.createNotifierCallback()
          : undefined
      }))
      // log.debug(devWebpackConfig.module.rules)
